...
🔭 Previous works: You can check out my previous talks at [meus_slides](https://github.com/btrzleal/meus_slides) and other fun coding projects by visiting [fun_with_R](https://github.com/btrzleal/fun_with_r) <br>
